"""
    ...
    From FedScale
    https://github.com/SymbioticLab/FedScale/blob/master/fedscale/utils/models/cv_models/shufflenet.py
"""
...
from evaluation.internal.models.cv_models.common import ChannelShuffle, conv1x1, conv3x3, depthwise_conv3x3
...
def get_shufflenet(groups,
    ...
    if pretrained:
        ...
        from evaluation.internal.models.cv_models.model_store import download_model
        download_model(
            net=net,
